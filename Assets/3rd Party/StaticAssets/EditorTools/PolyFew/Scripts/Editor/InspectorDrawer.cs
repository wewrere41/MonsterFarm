        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            if (FoldoutBatchFew)
            {
                ...
                if (didPressButton)
                {
                    ...
                    var colorSpace = (CombiningInformation.DiffuseColorSpace)Enum.Parse(typeof(CombiningInformation.DiffuseColorSpace), cS.ToUpperInvariant());
...
#region COMPRESSION QUALITY
                ...
                var compQuality = (CombiningInformation.CompressionQuality)Enum.Parse(typeof(CombiningInformation.CompressionQuality), cQ.ToUpperInvariant());
...
#region COLOR SPACE
        ...
        private void ResetTextureArrays()
        {
            ...
            var compQuality = (CompressionQuality)Enum.Parse(typeof(CombiningInformation.CompressionQuality), cQ.ToUpperInvariant());
